...
const erc1155Calls = async () => {
    ...
    const contractAddress = process.env.ERC1155_RINKEBY_ADDRESS;

    console.log("=======        ERC1155 Calls         =======");
    // Get the deployed NFT contract and set signer to be address present in loop
    const deployedContract = await hre.ethers.getContractAt("ERC1155_Token", contractAddress, accounts[0]);
